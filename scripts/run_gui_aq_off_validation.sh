...
exec sudo env \
  ...
  ORANGE_GUI_EXTERNAL_RECORDER_CONTRACT="${ORANGE_GUI_EXTERNAL_RECORDER_CONTRACT:-}" \
  ORANGE_GUI_EXTERNAL_RECORDER_CONTRACT_PATH="${ORANGE_GUI_EXTERNAL_RECORDER_CONTRACT_PATH:-}" \
  "${ORANGE_BIN}"
