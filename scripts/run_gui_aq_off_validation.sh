...
Validation environment:
  ...
  ORANGE_GUI_APP_CONFIG_PATH=${APP_CONFIG_PATH}
...
if [[ -n "${ORANGE_APP_CONFIG_PATH:-}" ]]; then
  ENV_ARGS+=("ORANGE_APP_CONFIG_PATH=${ORANGE_APP_CONFIG_PATH}")
elif [[ -n "${ORANGE_GUI_APP_CONFIG_PATH:-}" ]]; then
  ENV_ARGS+=("ORANGE_GUI_APP_CONFIG_PATH=${ORANGE_GUI_APP_CONFIG_PATH}")
elif [[ -f "${APP_CONFIG_PATH}" ]]; then
  ENV_ARGS+=("ORANGE_GUI_APP_CONFIG_PATH=${APP_CONFIG_PATH}")
fi
