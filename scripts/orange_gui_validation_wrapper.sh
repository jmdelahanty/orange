...
validate_env_item() {
  ...
  case "$key" in
    ...
    ORANGE_GUI_EXTERNAL_RECORDER_CONTRACT_PATH)
      ...
      ;;
    ORANGE_YOLO_PERF_LOG|ORANGE_CROP_COPY_TIMING|ORANGE_CROP_STAGE_SOURCE|ORANGE_ANALYTICS_EARLY_OWNED_FRAME|ORANGE_YOLO_DETACH_INPUT|ORANGE_YOLO_READY_EVENT_FASTPATH|ORANGE_RECORDING_DETECT_PRIORITY|ORANGE_GUI_SHOW_SPEED_GRAPHS|ORANGE_GUI_AUTORUN|ORANGE_GUI_AUTORUN_EXIT_AFTER_FINALIZE|ORANGE_GUI_AUTORUN_HIDE_CROP_PREVIEW|ORANGE_GUI_AUTORUN_ENABLE_STREAM|ORANGE_GUI_AUTORUN_ENABLE_RECORD|ORANGE_GUI_AUTORUN_ENABLE_YOLO|ORANGE_GUI_AUTORUN_ENABLE_CROP|ORANGE_GUI_AUTORUN_START_RECORDING|ORANGE_CROP_EXTERNAL_REQUIRE_SEPARATE_GPU|ORANGE_GUI_EXTERNAL_RECORDER_CONTRACT|ORANGE_CROP_PREVIEW_DISABLE|ORANGE_LOCAL_CONTROL_DISABLE|ORANGE_GUI_LOCAL_CONTROL_DISABLE|ORANGE_LOCAL_CONTROL_ENABLE_RECORDING_START|ORANGE_GUI_LOCAL_CONTROL_ENABLE_RECORDING_START|ORANGE_LOCAL_CONTROL_ENABLE_RECORDING_STOP|ORANGE_GUI_LOCAL_CONTROL_ENABLE_RECORDING_STOP|ORANGE_LOCAL_CONTROL_ENABLE_CITRUS_STOP|ORANGE_GUI_LOCAL_CONTROL_ENABLE_CITRUS_STOP)
      is_bool "$value" || {
