                                                  ...
                                                  int num_cameras)
{
    ...
    const nlohmann::json runtime_flags = {
        ...
        {"device_roi", flags.device_roi},
        {"device_crop", flags.device_crop},
        {"copy_after_pose", flags.copy_after_pose},
        {"fused_frame", flags.fused_frame},
        ...
        {"env_keys", {
            ...
            "ORANGE_ANALYTICS_DEVICE_ROI",
            "ORANGE_ANALYTICS_DEVICE_CROP",
            "ORANGE_ANALYTICS_COPY_AFTER_POSE",
            "ORANGE_ANALYTICS_FUSED_FRAME",
