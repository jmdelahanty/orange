...
static bool combo_select_string(const char* label,
                                std::string* value,
...
static std::string describe_gpio_recipe_validation(const CameraParams& camera_params)
{
...
static std::string format_gpio_node_value(const CameraGpioNodeConfig& node)
{
    if (node.type == "enum") {
