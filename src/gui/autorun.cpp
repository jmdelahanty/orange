...
// The env-parsing helpers below are file-local copies of the equivalents in
// orange.cpp, which remain there because the local-control code also uses
// them (mirrors recording_panel.cpp keeping its own env helpers).
