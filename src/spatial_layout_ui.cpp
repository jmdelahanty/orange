...
using orange::gui::spatial_layout::collect_citrus_single_circle_templates;
using orange::gui::spatial_layout::compute_file_fingerprint;
using orange::gui::spatial_layout::compute_json_fingerprint;
...
using orange::gui::spatial_layout::kSpatialLayoutManifestFilename;
...
using orange::gui::spatial_layout::update_spatial_calibration_session_index;
using orange::gui::spatial_layout::write_image_file;
using orange::gui::spatial_layout::write_json_file;
